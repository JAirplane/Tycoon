...
void GameManagement::CreateMenuAndElements()
{
	...
	menu_ptr->CreateMenuElement(ConstructionOptions::GetAllOptions()->GetToiletCost(), ConstructionOptions::GetAllOptions()->GetToiletDescription(),
		...
		ConstructionOptions::GetAllOptions()->GetToiletChosenBackgroundColor(), ConstructionOptions::GetAllOptions()->GetToiletSymbol(), ConstructionOptions::GetAllOptions()->GetToiletToiletNeed(),
		ConstructionOptions::GetAllOptions()->GetToiletHungerSatisfaction(), ConstructionOptions::GetAllOptions()->GetToiletVisitPrice(), ConstructionOptions::GetAllOptions()->GetToiletEntertainmentCost(),
		ConstructionOptions::GetAllOptions()->GetToiletExpences(), ConstructionOptions::GetAllOptions()->GetToiletHeightAdd(), ConstructionOptions::GetAllOptions()->GetToiletWidthAdd());
	menu_ptr->CreateMenuElement(ConstructionOptions::GetAllOptions()->GetIceCreamShopCost(),
		...
		ConstructionOptions::GetAllOptions()->GetIceCreamShopEntertainmentCost(), ConstructionOptions::GetAllOptions()->GetIceCreamShopExpences(),
	...
	menu_ptr->CreateMenuElement(ConstructionOptions::GetAllOptions()->GetFoodCourtCost(), ConstructionOptions::GetAllOptions()->GetFoodCourtDescription(),
		...
		ConstructionOptions::GetAllOptions()->GetFoodCourtEntertainmentCost(), ConstructionOptions::GetAllOptions()->GetFoodCourtExpences(),
	...
	if (preliminary_ptr != nullptr)
	{
		if (!allObjects_ptr->ObjectImposition(preliminary_ptr, camera_ptr, field_ptr))
		{
			if (preliminary_ptr->GetDescriptor()->GetConstructionCost() < menu_ptr->GetGameStats()->amountOfMoney)
			{
				...
				realObject_ptr->RedrawNeighbours(allObjects_ptr->GetAllRoads(), allObjects_ptr->GetAllBuildings(), allObjects_ptr->GetPreliminaryElement(), camera_ptr);
		...
		if (cursor_ptr->GetCursorConsoleLocation() == PointCoord(buttonHalfX, topY))
		{
			...
			if (chosen_ptr != nullptr)
			{
				if (chosen_ptr->IsBreakable())
				{
					...
					Construction::RedrawNeighbours(redrawPoint, allObjects_ptr->GetAllRoads(), allObjects_ptr->GetAllBuildings(),
						allObjects_ptr->GetPreliminaryElement(), camera_ptr);
					infoPanel_ptr->GetMessagesScreen()->GetConstructionInfoScreen()->GetDeconstructButton()->GetBorder()->
						SetBorderForegroundColor(ConstructionOptions::GetAllOptions()->GetButtonBorderInactiveColor());
					infoPanel_ptr->GetMessagesScreen()->GetConstructionInfoScreen()->ClearContent();
				}
