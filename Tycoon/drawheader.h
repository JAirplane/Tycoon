...
public:
	...
	void DrawIcon(int leftX, int topY, int constructionCost, int dailySpend, const wstring iconSymbol, string description, color foreground, color background = cBLACK);
